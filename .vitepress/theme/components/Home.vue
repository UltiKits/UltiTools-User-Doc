...
<template>
  <section id="hero">
    <h1 class="tagline">
      <span class="accent">新一代</span>
      <br />Spigot 基础插件
    </h1>
    <p class="description">
      简单易用，功能强大，适用场景丰富的 Spigot 基础插件。
    </p>
    <p class="actions">
  ...
  <section id="special-sponsor" class="center">
    <a class="lead" href="https://afdian.net/@ultikits">点击查看爱发电赞助鸣谢名单</a>
  </section>
  ...
  <section id="highlights" class="vt-box-container">
    <div class="vt-box">
      <h2>易学易用</h2>
      <p>
        提供简单明了的使用文档和直观的 GUI 界面，开箱即用，只需专注于内容搭建。
      </p>
    </div>
    <div class="vt-box">
      <h2>高兼容性</h2>
      <p>支持 Minecraft 1.8 - 1.19 及以上的 Spigot 服务端，实时跟进新版。</p>
    </div>
    <div class="vt-box">
      <h2>灵活多变</h2>
      <p>
        丰富的、可渐进式集成的生态系统，可以根据实际情况任意安装拓展模块。
      </p>
    </div>
  </section>
</template>
